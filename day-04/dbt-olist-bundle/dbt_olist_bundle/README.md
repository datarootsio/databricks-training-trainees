...
The 'dbt_olist_bundle' project was generated by using the dbt template for
...
3. Install dbt
   ...
   Run these instructions from the `dbt_olist_bundle` directory. We recommend making
...
`[dev yourname] dbt_olist_bundle_job` to your workspace.
...
When deploying to this target, note that the default job at resources/dbt_olist_bundle.job.yml
