...
orders = spark.table("training_sandro_couto.bronze.orders")
order_items = spark.table("training_sandro_couto.bronze.order_items")
customers = spark.table("training_sandro_couto.bronze.customers")
products = spark.table("training_sandro_couto.bronze.products")
order_payments = spark.table("training_sandro_couto.bronze.order_payments")
...
# your code here
orders.filter(F.col("order_status") == "shipped").select("order_id", "order_purchase_timestamp").display()
...
# MAGIC select count(*), customer_state
# MAGIC from training_sandro_couto.bronze.orders o join training_sandro_couto.bronze.customers c on o.customer_id = c.customer_id
...
# MAGIC FROM training_sandro_couto.bronze.order_payments
...
sellers = spark.table("training_sandro_couto.bronze.sellers")
