...
# MAGIC LEFT JOIN training_sandro_couto.bronze.products p ON oi.product_id = p.product_id
...
# Q4 — PySpark
order_reviews = spark.table("training_sandro_couto.bronze.order_reviews")
...
# MAGIC JOIN training_sandro_couto.bronze.customers c ON o.customer_id = c.customer_id
