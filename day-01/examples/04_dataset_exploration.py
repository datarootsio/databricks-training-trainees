...
# MAGIC LEFT JOIN training_marlene_mezzi.bronze.products p ON oi.product_id = p.product_id
...
# Q4 — PySpark
order_reviews = spark.table("training_marlene_mezzi.bronze.order_reviews")
