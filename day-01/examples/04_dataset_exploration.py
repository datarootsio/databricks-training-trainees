...
# MAGIC FROM training_julien_gafner.bronze.order_items oi
# MAGIC LEFT JOIN training_julien_gafner.bronze.products p ON oi.product_id = p.product_id
...
# Q4 — PySpark
order_reviews = spark.table("training_julien_gafner.bronze.order_reviews")
...
# MAGIC FROM training_julien_gafner.bronze.order_reviews
...
# MAGIC FROM training_julien_gafner.bronze.orders o
# MAGIC JOIN training_julien_gafner.bronze.customers c ON o.customer_id = c.customer_id
