...
# MAGIC
# MAGIC **Catalog/schema:** tables live in `training_julien_schneider.bronze`.
...
# MAGIC FROM training_julien_schneider.bronze.order_items oi
# MAGIC LEFT JOIN training_julien_schneider.bronze.products p ON oi.product_id = p.product_id
...
# Q4 — PySpark
order_reviews = spark.table("training_julien_schneider.bronze.order_reviews")
...
# MAGIC FROM training_julien_schneider.bronze.order_reviews
...
# MAGIC JOIN training_julien_schneider.bronze.customers c ON o.customer_id = c.customer_id
